...
class Empresa:
    def __init__(self, window):
        ...
        self.txtruc = Entry(frame)
        self.txtruc.grid(row=1, column=1)

        # razon social
        
        lb_rsocial = Label(frame, text="Razon Social: ")
        ...
        self.trv_empresas.heading("rsocial", text="Razon Social", anchor=CENTER)
