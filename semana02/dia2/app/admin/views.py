...
def proyectos():
    ...
    context = {"proyectos": lista_proyectos, "proyecto_form": proyecto_form}
...
def proyecto(id=""):
    ...
    if proyecto_form.validate_on_submit():
        ...
        proyecto_actualizado = fb.update_document(
            "proyectos", id, data_proyecto_actualizar
        )
...
def social_network():
    ...
    if social_network_form.validate_on_submit():
        ...
        new_social_network_doc = fb.insert_document(
            "redes_sociales", data_new_social_network
        )
...
def social_network_by_id(id=""):
    ...
    if social_network_form.validate_on_submit():
        ...
        social_network_updated = fb.update_document(
            "redes_sociales", id, data_new_social_network
        )
        return redirect(url_for("admin.social_network"))
